...
async function runMigration() {
  try {
    ...
    const migrationPath = path.join(__dirname, 'migrations', 'create_paper_specifications.sql');
    ...
    console.log('📄 Copy and paste: migrations/create_paper_specifications.sql');
