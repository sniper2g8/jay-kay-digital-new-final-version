...
-- Customer Consolidation Migration (Without Foreign Key)
...
-- Add app_user_id without foreign key constraint for now
ALTER TABLE customers ADD COLUMN IF NOT EXISTS app_user_id TEXT;
