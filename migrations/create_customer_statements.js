...
async function createCustomerStatementsSchema() {
  console.log("🏗️  Creating Customer Statements System");
  console.log("=====================================\n");

  try {
    console.log("📋 Step 1: Creating customer statements tables...");
...
-- Insert default statement settings
...
-- Create account balances for existing customers
...
-- Sample statement period and transactions
DO $$
DECLARE
  sample_customer_id UUID;
  sample_period_id UUID;
BEGIN
  -- Get first customer
  SELECT id INTO sample_customer_id FROM customers LIMIT 1;
  
  IF sample_customer_id IS NOT NULL THEN
    -- Create sample statement period
    INSERT INTO customer_statement_periods (
      customer_id,
      statement_number,
      period_start,
      period_end,
      ...
      'generated',
      TRUE
    ) RETURNING id INTO sample_period_id;
    ...
    (
      ...
      '2024-09-05',
      'charge',
      'Business Card Printing - 500 cards',
      'JOB-0001',
      750.00,
      750.00
    ),
    (
      ...
      '2024-09-15',
      'charge',
      'Brochure Design & Print - 200 copies',
      'JOB-0002',
      1000.00,
      1750.00
    ),
...
END $$;
    ...
    console.log("\n🔧 Features Included:");
    console.log("   • Automatic balance calculations");
    console.log("   • Running balance tracking");
    console.log("   • Credit limit management");
    console.log("   • Statement period management");
