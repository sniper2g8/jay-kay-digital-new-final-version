...
async function fixAllRLSIssues() {
  ...
  try {
    ...
    // Test customers
    try {
      const customersResult = await client.query('SELECT COUNT(*) as count FROM public.customers');
    ...
    // Test invoices
    try {
      const invoicesResult = await client.query('SELECT COUNT(*) as count FROM public.invoices');
    ...
    // Test payments
    try {
      const paymentsResult = await client.query('SELECT COUNT(*) as count FROM public.payments');
    ...
    try {
      const jobsResult = await client.query('SELECT COUNT(*) as count FROM public.jobs');
