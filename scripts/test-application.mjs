...
async function testApplication() {
  ...
  try {
    ...
    if (paperWeightsError) {
      console.log('❌ Failed to access paper_weights:', paperWeightsError.message);
    } else {
    ...
    console.log('📝 Summary: Most functionality is working. The finish_options table needs permission fixes.');
    console.log('   Run the SQL scripts in fix-rls-policies.sql and populate_finish_options.sql');
