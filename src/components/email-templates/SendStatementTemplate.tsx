  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{ textAlign: 'right' }}>
            <h3 style={{ margin: '0 0 10px 0', color: '#dc2626' }}>Account Holder:</h3>
        ...
        <div style={{
          ...
          <div style={{
            ...
            <h4 style={{ ...summaryTitleStyle, color: '#ffffff' }}>Closing Balance</h4>
            <p style={{
              ...summaryValueStyle,
              color: '#ffffff',
              fontSize: '20px'
              ...
              {transactions.map((transaction, index) => (
                <tr key={index} style={{
                  ...
                  <td style={{ ...tableCellStyle, textAlign: 'right', color: '#dc2626' }}>
                    {transaction.debit ? `SLL ${transaction.debit.toLocaleString()}` : '-'}
                  </td>
                  <td style={{ ...tableCellStyle, textAlign: 'right', color: '#059669' }}>
                    {transaction.credit ? `SLL ${transaction.credit.toLocaleString()}` : '-'}
                  </td>
                  <td style={{
                    ...tableCellStyle,
                    textAlign: 'right',
      ...
      <div style={{
        ...
        <h3 style={{ margin: '0 0 15px 0', color: '#dc2626' }}>Payment Instructions</h3>
      ...
      <div style={{
        ...
        <p style={{
          ...
          For questions about this statement, please contact us during business hours.
        </p>
      </div>
    </div>
  );
...
export const generateStatementEmailHTML = (props: SendStatementTemplateProps): string => {
  return `
    <!DOCTYPE html>
    <html>
    <head>
