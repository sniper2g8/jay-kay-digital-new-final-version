...
export const PaymentReceiptPDF = forwardRef<
  PaymentReceiptPDFRef,
  PaymentReceiptPDFProps
>(({ payment, customer, invoice, showActions = true }, ref) => {
      ...
      >
          ...
          <div>
            ...
            <div className="bg-gray-50 p-3 rounded-lg space-y-1.5">
              <div className="font-medium text-gray-900 text-sm">
                {customer?.business_name || payment.customer_human_id}
              </div>
        ...
        <div className="border-t border-gray-200 pt-4 text-center">
          <div className="text-xs text-gray-600 space-y-1.5">
            ...
            <p>
              This receipt serves as proof of payment. Please retain for your
              records.
            </p>
            <p>
              For questions about this payment, please contact us at
              info@jaykaydigitalpress.com
            </p>
          </div>

          <div className="mt-3 text-xs text-gray-500">
            Receipt generated on {formatDate(createdDate.toISOString())} | Jay
            Kay Digital Press © 2025
          </div>
        </div>
      </div>
    </div>
