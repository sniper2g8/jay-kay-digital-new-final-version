      ...
      <Page size="A4" style={styles.page} wrap>
        ...
        <View style={styles.header}>
          ...
          <View style={styles.invoiceDetails}>
            ...
            <Text style={styles.invoiceDetail}>
              Issue Date: <Text style={styles.bold}>{fmtDate(invDate)}</Text>
            </Text>
            <Text style={styles.invoiceDetail}>
              Due Date: <Text style={styles.bold}>{fmtDate(dueDate)}</Text>
            </Text>
          </View>
        </View>
        ...
        <View style={styles.billToContainer}>
          ...
          {customer ? (
            <View>
              ...
              {customer.country && (
                <Text style={styles.billToContent}>{customer.country}</Text>
              )}
              {customer.phone && (
                <Text style={styles.billToContent}>
...
export async function downloadInvoicePDF(
  ...
  const blob = await pdf(
    <InvoicePDFDocument invoice={invoice} customer={customer} items={items} />,
  ).toBlob();
