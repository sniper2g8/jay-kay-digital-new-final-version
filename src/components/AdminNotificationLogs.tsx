...
export default function AdminNotificationLogs() {
  ...
  const [selectedNotification, setSelectedNotification] = useState<
    EmailNotification | SystemNotification | null
  >(null);
    ...
    try {
      ...
      if (error) {
        if (
          ...
          throw new Error(
            "Permission denied - RLS policies need to be configured for notifications table. Please check the FIX_NOTIFICATIONS_RLS.md file for instructions.",
          );
        }
        throw error;
      }
  ...
  const exportNotifications = () => {
    const dataToExport =
      activeTab === "email" ? emailNotifications : systemNotifications;
    let csvContent = "";
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-gray-600">
              Monitor and track all system and email notifications
            </p>
          </div>
        </div>
            ...
            <div>
              <Select value={typeFilter} onValueChange={setTypeFilter}>
                ...
                <SelectContent>
                  ...
                  <SelectItem value="job_status_change">
                    Status Update
                  </SelectItem>
                  <SelectItem value="payment_received">
                    Payment Received
                  </SelectItem>
                  <SelectItem value="statement_ready">
                    Statement Ready
                  </SelectItem>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-xs font-mono">
                          {selectedNotification.resend_id || "N/A"}
                        </p>
                      </div>
                    </div>
                    <div>
                      ...
                      <div>
                        ...
                        <p>
                          ...
                          {selectedNotification.read_at &&
                            ` on ${new Date(selectedNotification.read_at).toLocaleString()}`}
                        </p>
                      </div>
