...
import { Loader2, Send, Mail, MessageSquare, Bell, CheckCircle } from 'lucide-react';
...
const NotificationManager: React.FC<NotificationTestProps> = ({ className = '' }) => {
  ...
  // Form state
  const [notificationType, setNotificationType] = useState<NotificationType>('job_submission');
      ...
      <Card>
        ...
        <CardContent>
          ...
          <div className="mt-4 p-3 bg-blue-50 border border-blue-200 rounded-lg">
            <h4 className="font-medium text-blue-900 mb-2">Configuration Note</h4>
            <p className="text-sm text-blue-800">
              Email notifications are ready to use. SMS notifications require Twilio configuration in environment variables.
              Contact your system administrator to set up SMS service credentials.
            </p>
          </div>
        </CardContent>
      </Card>
          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between p-3 border rounded-lg">
              <div>
                ...
                <p className="text-sm text-muted-foreground">Customer confirmation when job is submitted</p>
              </div>
            ...
            <div className="flex items-center justify-between p-3 border rounded-lg">
              <div>
                ...
                <p className="text-sm text-muted-foreground">Notification when job status changes</p>
              </div>
              <Button variant="outline" size="sm">
                Preview
              </Button>
            ...
            <div className="flex items-center justify-between p-3 border rounded-lg">
              <div>
                ...
                <p className="text-sm text-muted-foreground">Receipt confirmation for payments</p>
              </div>
              <Button variant="outline" size="sm">
                Preview
              </Button>
            ...
            <div className="flex items-center justify-between p-3 border rounded-lg">
              <div>
                ...
                <p className="text-sm text-muted-foreground">Customer notification for new invoices</p>
              </div>
              <Button variant="outline" size="sm">
                Preview
              </Button>
