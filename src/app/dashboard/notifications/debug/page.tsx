        ...
        <Card className="mb-6 bg-yellow-50 border-yellow-200">
          ...
          <CardContent>
            <p className="text-yellow-700 mb-2">
              The error indicates that Row Level Security (RLS) policies are not
              properly configured for the notifications table.
            </p>
            <p className="text-yellow-700 mb-2">
              Please follow the instructions in{" "}
              <code className="bg-yellow-100 px-1 rounded">
                FIX_NOTIFICATIONS_RLS.md
              </code>{" "}
              to fix this issue.
            </p>
            <p className="text-yellow-700">
              Specifically, you need to add policies that allow users to access
