            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                <div className="space-y-1 text-sm">
                  <div
                    className={`flex items-center gap-2 ${(preferences.email_notifications ?? false) ? "text-green-600" : "text-gray-500"}`}
                  >
                  ...
                  <div
                    className={`flex items-center gap-2 ${(preferences.sms_notifications ?? false) ? "text-green-600" : "text-gray-500"}`}
                  >
              ...
              <div className="space-y-2">
                ...
                <div className="space-y-1 text-sm">
                  <div
                    className={`${(preferences.job_status_updates ?? false) ? "text-green-600" : "text-gray-500"}`}
                  >
                    Job Status:{" "}
                    {(preferences.job_status_updates ?? false)
                      ? "Enabled"
                      : "Disabled"}
                  </div>
                  <div
                    className={`${(preferences.delivery_updates ?? false) ? "text-green-600" : "text-gray-500"}`}
                  >
                    Delivery:{" "}
                    {(preferences.delivery_updates ?? false)
                      ? "Enabled"
                      : "Disabled"}
                  </div>
                  <div
                    className={`${(preferences.promotional_messages ?? false) ? "text-green-600" : "text-gray-500"}`}
                  >
                    Promotions:{" "}
