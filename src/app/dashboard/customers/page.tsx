  ...
  const handleDeleteCustomer = async (
    ...
    try {
      ...
      if (jobs && jobs.length > 0) {
        toast.error(
          `Cannot delete ${customerName}. Customer has existing jobs.`,
        );
        return;
      }
        ...
        <div className="p-6">
            ...
            <Card>
              ...
              <CardContent>
                ...
                <p className="text-xs text-muted-foreground">
                  {activeCustomers.length} active, {inactiveCustomers.length}{" "}
                  inactive
                </p>
              </CardContent>
            </Card>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Complete list of customers with human-readable IDs
              </CardDescription>
            </CardHeader>
            <CardContent>
              {filteredCustomers && filteredCustomers.length > 0 ? (
                <div className="space-y-4">
                  {filteredCustomers.map((customer) => (
                    <div
                      key={customer.human_id || customer.id}
                          ...
                          <Button
                            ...
                            onClick={() =>
                              handleDeleteCustomer(
                                customer.id,
                                customer.business_name || "Unknown Customer",
                              )
                            }
