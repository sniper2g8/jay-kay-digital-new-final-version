    ...
    <div className="space-y-6">
      <div className="text-center mb-8">
        ...
        <p className="text-gray-600">
          Please review all details before submitting your job
        </p>
      </div>
          ...
          <CardContent>
            <div className="space-y-3">
              <div className="flex justify-between">
                <span>
                  Base Price ({formData.quantity} × SLL{" "}
                ...
                <>
                  ...
                  {formData.finishing_options.map((optionId) => {
                    ...
                    return (
                      ...
                      >
                        <span>
                          {option?.name} ({formData.quantity} × SLL{" "}
                          {price.toFixed(2)})
                        </span>
              ...
              <p className="text-xs text-gray-500 mt-2">
                * This is an estimate. Final pricing may vary based on actual
          ...
          <CardContent className="pt-6">
            <div className="text-center">
              ...
              <p className="text-blue-700 text-sm">
                Please review all information above. Once submitted, you&apos;ll
                receive a confirmation email and can track your job&apos;s
