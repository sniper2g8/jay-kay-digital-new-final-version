          ...
          >
            <DialogTrigger asChild>
              <Button
                type="button"
                variant="outline"
                className="h-10 px-4 border border-gray-300 hover:border-blue-500 transition-colors"
              >
              ...
              <div className="space-y-4">
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        updateNewCustomerData("business_name", e.target.value)
                      }
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        updateNewCustomerData("contact_person", e.target.value)
                      }
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        updateNewCustomerData("email", e.target.value)
                      }
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        updateNewCustomerData("phone", e.target.value)
                      }
                ...
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      updateNewCustomerData("address", e.target.value)
                    }
