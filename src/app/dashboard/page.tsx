      ...
      <div className="px-4 py-6 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
          ...
          <Card className="hover-lift transition-all border-primary/20">
            ...
            <CardContent>
              <div className="text-2xl font-bold text-foreground">
                {financialStatsLoading ? '...' : formatCurrency(financialStats?.total_revenue || 0)}
              </div>
              <p className="text-xs text-muted-foreground">
              ...
              {jobStatsLoading || customersLoading || financialStatsLoading ? (
                ...
                <div className="space-y-4">
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      <p className="text-sm font-medium text-foreground">New job submitted</p>
            ...
            <Card className="hover-lift transition-all cursor-pointer border-primary/20">
              ...
              <CardContent>
                <div className="flex items-center justify-between">
                  ...
                  <Button variant="ghost" size="sm" className="hover-lift hover:bg-primary/10">
...
export default function DashboardPage() {
  return (
    <ProtectedDashboard allowedRoles={['super_admin', 'admin', 'manager', 'staff', 'customer']}>
      <DashboardContent />
    </ProtectedDashboard>
  );
}