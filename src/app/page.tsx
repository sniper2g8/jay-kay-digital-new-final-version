...
export default function Home() {
  ...
  const services = [
    {
      ...
      description:
        "Professional business cards with various paper stocks and finishes to make a lasting impression.",
      image: "/services/Business-card.jpg",
    },
    {
      title: "Digital Printing",
      description:
        "Fast turnaround for small to medium runs with exceptional quality and customization options.",
      image: "/services/Digital-Printing.jpg",
    },
    {
      title: "Brochures & Booklets",
      description:
        "Eye-catching brochures and booklets for marketing campaigns and product information.",
      image: "/services/brochures and booklets.png",
    },
    {
      title: "Signage & Banners",
      description:
        "Large format printing for indoor and outdoor signage, roll-up banners, and promotional displays.",
  ...
  const testimonials = [
    {
      ...
      content:
        "Jay Kay Digital Press transformed our marketing materials. The quality is exceptional and delivery is always on time.",
      rating: 5,
    },
    {
      ...
      content:
        "Professional service from start to finish. Their attention to detail makes all the difference in our client presentations.",
      rating: 5,
    },
    {
      name: "Amina Kamara",
      ...
      content:
        "Reliable, high-quality printing services at competitive prices. They've become our go-to printing partner.",
      rating: 5,
    },
  ];
  ...
  return (
    <div
      className="min-h-screen bg-gradient-to-br from-white via-red-50 to-yellow-50"
          ...
          {isMenuOpen && (
            <div className="md:hidden mt-4 pb-4">
              <div className="flex flex-col space-y-3">
                <a
                  href="#services"
                  className="text-gray-300 hover:text-red-400 transition-colors py-2"
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-3xl">
            ...
            <p className="text-xl text-gray-200 mb-8">
              From concept to delivery, we provide exceptional printing services
              with fast turnaround times and competitive pricing for businesses
              across Sierra Leone.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <Button
                ...
                variant="outline"
                asChild
                className="border-white text-white hover:bg-white/10 text-lg py-6 px-8 bg-transparent"
              >
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Professional printing solutions tailored to meet your business
              needs with exceptional quality and fast delivery.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {services.map((service, index) => (
              <Card
                key={index}
                className="hover:shadow-xl transition-all duration-300 border-red-200 hover:border-red-300 overflow-hidden"
              >
          ...
          <div className="flex flex-col lg:flex-row items-center gap-12">
            ...
            <div className="lg:w-1/2">
              ...
              <p className="text-gray-600 mb-6 text-lg">
                With years of experience in the printing industry, we combine
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              ...
              we&apos;ve helped grow through quality printing services.
            </p>
          </div>
      ...
      <section className="py-20 bg-gradient-to-r from-red-700 to-red-900 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8 max-w-2xl mx-auto text-red-100">
            Get started with Jay Kay Digital Press today and experience the
            difference that professional printing can make for your business.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Button
              ...
              variant="outline"
              asChild
              className="border-white text-white bg-transparent hover:bg-white hover:text-red-700"
            >
          ...
          <div className="grid md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-gray-400 mb-4">
                Professional printing services for businesses across Sierra
                Leone.
              </p>
            </div>
