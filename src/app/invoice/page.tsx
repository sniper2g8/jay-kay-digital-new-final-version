      ...
      <div className="container mx-auto py-8">
        ...
        <div className="bg-white rounded-lg shadow p-8">
          ...
          <p className="text-gray-600 mb-6">
            Welcome to the Jay Kay Digital Press invoice management system. This
            system allows you to create, manage, and send professional invoices
            to your customers.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
            ...
            <div className="border border-gray-200 rounded-lg p-6">
              ...
              <p className="text-gray-600 mb-4">
                To create a new invoice, click on the &quot;Invoice
                Management&quot; button above.
              </p>
              <p className="text-gray-600">
                You can preview the invoice template or view a demo to see how
                it works.
              </p>
            </div>
          </div>
