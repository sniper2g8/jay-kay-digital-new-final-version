  ...
  return (
    <div className="p-8 max-w-2xl mx-auto">
      ...
      <div className="space-y-4">
        ...
        {testResult && (
          <div
            className={`p-4 rounded ${testResult.includes("Success") ? "bg-green-100 text-green-800" : "bg-red-100 text-red-800"}`}
          >
        ...
        <div className="bg-gray-100 p-4 rounded">
          ...
          <p className="text-sm mt-2">
            This test bypasses all authentication checks and directly queries
            the database. If this fails, the issue is with RLS policies. If this
            succeeds, the issue is with the authentication context in the hooks.
          </p>
        </div>
      </div>
    </div>
