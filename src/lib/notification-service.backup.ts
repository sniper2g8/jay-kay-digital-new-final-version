...
interface NotificationData {
  ...
  template_variables?: Record<string, string | number | boolean | null | undefined>;
}
...
class NotificationService {
  ...
  private async logNotificationError(
    ...
    try {
      // Error logging handled internally, no additional logging needed
      ...
      // Error logging notification error, no additional logging needed
    }
  }
  ...
  private async logEmailNotification(logData: {
    ...
    try {
      ...
      if (insertError) {
        // Error logging email notification, no additional logging needed
      }
    } catch (error) {
      // Error logging email notification, no additional logging needed
    }
