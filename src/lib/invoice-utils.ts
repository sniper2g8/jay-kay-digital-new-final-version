...
export function transformFirebaseTimestamp(
  timestamp: FirebaseTimestamp | string | null,
): string | null {
...
export function transformRawInvoice(
  rawInvoice: RawInvoiceFromDB,
): TransformedInvoice {
  return {
    id: rawInvoice.id,
    ...
    issue_date:
      transformFirebaseTimestamp(rawInvoice.issueDate) ||
      rawInvoice.invoice_date,
    due_date:
      transformFirebaseTimestamp(rawInvoice.dueDate) || rawInvoice.due_date,
