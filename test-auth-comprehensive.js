...
console.log(
  "📋 This will test signup, login, password reset, and database access",
);
console.log(
  "🔧 Helps identify if the issue is with existing users or the auth service itself\n",
);
